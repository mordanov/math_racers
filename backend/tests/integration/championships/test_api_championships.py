...
def _post_race(token: str, mode: str = "championship") -> str:
    ...
    resp = httpx.post(
        ...
        json={
            ...
            "participants": [
                {"avatar_id": "a1", "position": 1, "problems_correct": 7,
                 "average_response_ms": 1200, "total_distance": 126, "xp_earned": 70},
                {"avatar_id": "a2", "position": 2, "problems_correct": 5,
                 "average_response_ms": 1800, "total_distance": 90, "xp_earned": 50},
            ],
        },
